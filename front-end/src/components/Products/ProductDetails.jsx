    ...
    <div className="p-4 sm:p-6">
      <div className="max-w-6xl mx-auto bg-white p-4 sm:p-8 rounded-lg">
        <div className="flex flex-col md:flex-row gap-6 md:gap-8">
          {/* Thumbnails */}
          <div className="flex md:flex-col md:space-y-4 md:mr-6 gap-3 overflow-x-auto pb-2 md:pb-0">
            {selectedProduct.images.map((img, index) => (
              <img
                key={index}
                src={img.url}
                alt={img.altText}
                className={`w-20 h-20 shadow-md object-cover hover:scale-105 transition duration-300 cursor-pointer border rounded-lg flex-shrink-0 transition 
                  ${
                    mainImage === img.url
